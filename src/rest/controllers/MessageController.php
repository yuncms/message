...
namespace yuncms\message\rest\controllers;
...
use yuncms\message\rest\models\Message;
...
class MessageController extends Controller
{
    ...
    {
        $total = Message::getDb()->cache(function () {
    ...
    protected function findModel($id)
    {
        if (($model = Message::find()
            ...
            throw new NotFoundHttpException("Session does not exist: $id");
        }
    }
}